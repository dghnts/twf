...
- [x] 5. 背景画像/背景色の検出機能の実装
  ...
  - [x] 5.12 OSC 11レスポンスパースのプロパティテストを作成
    - **Property 2: OSC 11レスポンスのパース**
    - **Validates: Requirements 2.1.7**

- [x] 6. チェックポイント - 検出機能の確認
  - すべてのテストが通ることを確認し、質問があればユーザーに確認してください

- [x] 7. カラースキームとフォント設定の生成
...
- [x] 8. 設定適用とバックアップ機能の実装
  ...
  - [x] 8.10 ファイル操作ユーティリティの実装（utils/file.rs）
    - append_to_file関数を実装
    - remove_existing_twf_block関数を実装
    - confirm_apply関数を実装（ユーザー確認）
    - _Requirements: 2.5.2, 3.6.1_

- [x] 9. チェックポイント - 設定適用機能の確認
  - すべてのテストが通ることを確認し、質問があればユーザーに確認してください

- [x] 10. CLIインターフェースとプレビュー機能の実装
  - [x] 10.1 CLI引数パースの実装（cli.rs）
...
- [x] 12. 統合とエンドツーエンドテスト
  - [x] 12.1 統合テストの作成（tests/integration/）
